...
//	{
//		ballArr.clear();
//		ballArr.push_back(Ball(3, 0, 100, 100, 50));
//		ballArr.push_back(Ball(-2, -2, 200, 100, 40));
//		/*ballArr.push_back(Ball(3, -2, 200, 200, 10));
//		ballArr.push_back(Ball(3, 2, 100, 200, 20));*/
//		time = 0.1;
...
//		}
//
//		ballArr[0].CheckBallCollision(ballArr[1]);
//
